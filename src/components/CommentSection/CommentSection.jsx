    ...
    return (
        <div>
            <div className='flex gap-5 mb-5'>
                <p className='text-xl font-semibold'>1884 Comments</p>
            ...
            <div className='flex my-3'>
                ...
                <div className="ml-5">
                    ...
                    <p className='text-sm'>aslfksdjfopsdjf sodif jseopdifjw eoipfsadpoif mesaoipf uawepsofsamdopfisudaf oipcvpoiasdj vcopweriuf posdifmv pasodif uweapofiusadofijsda fopi</p>
